...
function Profile() {
  ...
  return (
    ...
    <div className="w-full h-full flex flex-col bg-slate-50 overflow-hidden">
      ...
      <div className="w-full bg-blue-600 rounded-xl px-6 py-4 flex items-center gap-3 shadow-sm shrink-0">
      ...
      <div className="flex-1 overflow-y-auto sm:overflow-hidden  flex justify-center sm:py-8 sm:px-4">
        ...
        className="w-full max-w-2xl flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm px-6 py-2 sm:py-6">
