...
import { CloudCog, NotebookPen, NotepadText } from "lucide-react";
...
function CalendarMentions() {
    ...
    const { loading: loadingSenderMentions, error: errorSenderMentions, data: dataSenderMentions } = useQuery(GET_MENTIONS_BY_SENDER, { variables: { senderId: userId } });
    console.log("dataSenderMentions", dataSenderMentions);
    ...
    return (
        <Fragment>
            ...
            {/* modal*/}
            {
                (openAddNote) && <Addmention open={openAddNote} setOpen={setOpenAddNote} datemention={dayClick} />
            }
        </Fragment>
    )
}
